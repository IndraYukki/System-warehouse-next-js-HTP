      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              <Button asChild className="w-full">
                <Link href="/finishgood/inbound">Tambah Barang Masuk</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Button asChild className="w-full">
                <Link href="/finishgood/outbound">Keluarkan Barang</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Button asChild variant="outline" className="w-full">
                <Link href="/finishgood/inventory">Lihat Inventory</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Button asChild variant="outline" className="w-full">
                <Link href="/finishgood/history">Lihat Riwayat</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
